...
2. docker compose up -d et attendre le temps que Gitlab soit accessible via l'url(url ajouté dans le /etc/hosts)
...
9. Set-up le projet "ScannerGITLAB" et suivre les instructions de sonarqube pour ajouter avoir l'analyse:
